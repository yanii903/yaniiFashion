                            ...
                            <div class="wrap-sidebar-account">
                                <ul class="my-account-nav">
                                    <ul class="my-account-nav">
                                        ...
                                        <li><span class="my-account-nav-item active">Đơn Hàng</span></li>
                            ...
                            <div class="my-account-content account-order">
                                <div class="wrap-account-order">
                                    <table>
                                        ...
                                        <tbody>
                                            <?php foreach ($load_all_order_user as $order) {
                                                extract($order);

                                                if ($trang_thai !== "Đã Bị Hủy" && $trang_thai !== "Đã Nhận Hàng") {
                                            ?>
                                                    <tr class="tf-order-item">
                                                        ...
                                                        <td>
                                                            <?php if ($trang_thai == "Giao Hàng Thành Công") { ?>
                                                                <a href="?client=viewOrderUpdate&userId=<?= $_SESSION['userId'] ?>&orderDetailId=<?= $id; ?>" class="tf-btn bg-success w-50 text-light animate-hover-btn rounded-0 justify-content-center">
                                                                    <span>Nhận</span>
                                                                </a>
                                                            <?php } else { ?>
                                                                <a href="?client=viewOrder&userId=<?= $_SESSION['userId'] ?>&orderDetailId=<?= $id; ?>" class="tf-btn btn-fill w-50 animate-hover-btn rounded-0 justify-content-center">
                                                                    <span>Xem</span>
                                                                </a>
                                                            <?php } ?>
                                                        </td>
