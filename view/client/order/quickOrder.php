                                ...
                                <form class="tf-page-cart-checkout widget-wrap-checkout">
                                    <ul class="wrap-checkout-product">
                                        <?php if (isset($load_one_product)) {
                                            ...
                                            if (isset($load_one_quick_order)) {
                                        ?>
                                                <li class="checkout-product-item">
                                                    <figure class="img-product">
                                                        <img src="/myProject/view/assets/be/images/products/<?= $hinh_anh; ?>" alt="product">
                                                        <span class="quantity"><?= $load_one_quick_order['so_luong']; ?></span>
                                                    </figure>
                                                    <div class="content">
                                                        <div class="info">
                                                            <p class="name"><?= $ten_san_pham; ?></p>
                                                            <span class="variant"><?= $load_one_quick_order['mau_sac']; ?> / <?= $load_one_quick_order['kich_co']; ?></span>
                                                        </div>
                                                        <span class="price text-danger"><?= number_format($load_one_quick_order['so_luong'] * $gia_giam, 0, ',', '.'); ?>đ</span>
                                                    </div>
                                                </li>
                                        <?php }
                                        } ?>
                                    ...
                                    <div class="d-flex justify-content-between line pb_20">
                                        ...
                                        <h6 class="total fw-5 text-danger"><?= number_format($load_one_quick_order['so_luong'] * $gia_giam, 0, ',', '.'); ?>đ</h6>
                                    </div>
