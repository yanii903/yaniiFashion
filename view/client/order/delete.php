        ...
        <div id="wrapper">
            ...
            <div class="tf-page-title">
                <div class="container-full">
                    <div class="heading text-center">Đơn Hàng Đã Hủy</div>
                </div>
            </div>
            <!-- /page-title -->
                            ...
                            <div class="wrap-sidebar-account">
                                <ul class="my-account-nav">
                                    <ul class="my-account-nav">
                                        ...
                                        <li><span class="my-account-nav-item active">Đơn Hàng Đã Hủy</span></li>
                            ...
                            <div class="my-account-content account-order">
                                <div class="wrap-account-order">
                                    <table>
                                        ...
                                        <tbody>
                                            <?php foreach ($load_all_order_user_delete as $order) {
                                                extract($order);
                                            ?>
