    ...
    <div id="wrapper">
        ...
        <div class="tf-page-title style-2">
            <div class="container-full">
                <div class="heading text-center">Tìm Kiếm</div>
            </div>
        </div>
        <!-- /page-title -->
        <div class="flat-spacing-8 page-search-inner">
            <div class="tf-search-head">
                <form class="tf-mini-search-frm" method="POST">
                    <fieldset class="text">
                        <input type="text" placeholder="Tìm Kiếm Sản Phẩm" class="" name="inputSearch" tabindex="0" value="<?= $_POST['inputSearch'] ?? '' ?>" aria-required="true">
                    </fieldset>
                    <button type="submit" name="btnSearch"><i class="icon-search"></i></button>
                </form>
                <div class="tf-col-quicklink">
                    <span class="title">Được Để Xuất:</span>
                    <a href="?client=categoryChange&option=male">Nam</a>,
                    <a href="?client=categoryChange&option=female">Nữ</a>,
                    <a href="?client=promotion">Khuyến Mại</a>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="tf-search-content-title">
                            Bạn Đang Tìm Phong Cách Cho Riêng Bạn?
                        </div>
                    </div>
