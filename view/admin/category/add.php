                                        ...
                                        <form class="form-new-product form-style-1" method="POST" enctype="multipart/form-data">
                                            <fieldset class="name">
                                                ...
                                                <div class="d-block w-full">
                                                    <input class="mb-10 w-full" type="text" placeholder="Nhập Tên Danh Mục" name="name" tabindex="0" value="<?= $_POST['name'] ?? '' ?>">
                                            ...
                                            <fieldset>
                                                <div class="body-title">Tải Logo Lên <span class="tf-color-1">*</span></div>
                                                <div class="d-block">
                                                    <div class="upload-image flex-grow mb-10">
                                                        <div class="item up-load">
                                                            <label class="uploadfile h250" for="myFile">
                                                                ...
                                                                <span class="body-text">Thả hình ảnh của bạn ở đây hoặc chọn <span class="tf-color">Bấm để duyệt</span></span>
                                            ...
                                            <div class="bot">
                                                <div></div>
                                                <button class="tf-button w-full" type="submit" name="btnAddCategory">Thêm Mới</button>
