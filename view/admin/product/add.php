                                ...
                                <div class="main-content-wrap">
                                    ...
                                    <form class="form-add-product" enctype="multipart/form-data" method="POST">
                                        <div class="wg-box mb-30">
                                            <fieldset>
                                                <div class="body-title mb-10">Tải Ảnh Lên</div>
                                        ...
                                        <div class="wg-box mb-30">
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="Nhập Tên Sản Phẩm" name="name" tabindex="0" value="<?= $_POST['name'] ?? '' ?>">
                                            ...
                                            <fieldset class="category">
                                                ...
                                                <select name="category" class="mb-10">
                                                    <option value="0" <?= (isset($_POST['category']) && $_POST['category'] == '0') ? 'selected' : '' ?>>- Vui Lòng Chọn Danh Mục -</option>
                                                    <?php foreach ($load_all_category as $category): extract($category) ?>
                                                        <option value="<?= $id; ?>" <?= (isset($_POST['category']) && $_POST['category'] == '$id') ? 'selected' : '' ?>><?= $ten_danh_muc; ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            ...
                                            <div class="cols-lg gap22">
                                                <fieldset class="price">
                                                    ...
                                                    <input class="mb-10" type="number" placeholder="Nhập Giá Gôc" name="price" tabindex="0" value="<?= $_POST['price'] ?? '' ?>">
                                                ...
                                                <fieldset class="sale-price">
                                                    ...
                                                    <input class="mb-10" type="number" placeholder="Nhập Giá Khuyến Mại" name="salePrice" tabindex="0" value="<?= $_POST['salePrice'] ?? '' ?>">
                                                ...
                                                <fieldset class="quantity">
                                                    ...
                                                    <input class="mb-10" type="number" name="quantity" placeholder="Nhập Số Lượng Sản Phẩm" tabindex="0" value="<?= $_POST['quantity'] ?? '' ?>">

                                                    <?php if (!empty($messQuantity)): ?>
                                                        <i style="color: red; margin: 5px;" class="fs-4"><?php echo $messQuantity; ?></i>
                                                    <?php endif; ?>
                                                </fieldset>
                                            </div>
                                            ...
                                            <fieldset class="description">
                                                ...
                                                <textarea class="mb-10" name="description" value="<?= $_POST['description'] ?? '' ?>" placeholder="Nhập Mô Tả" tabindex="0"></textarea>
                                                ...
                                                <div class="right flex-grow">
                                                    <fieldset class="mb-24">
                                                        ...
                                                        <div class="radio-buttons">
                                                            <div class="item">
                                                                <input class="" type="radio" name="sex" id="add-product1" value="Nam" checked>
                                                                <label class="" for="add-product1"><span class="body-title-2">Nam</span></label>
                                                            </div>
                                                            <div class="item">
                                                                <input class="" type="radio" name="sex" id="add-product2" value="Nữ">
                                        ...
                                        <div class="cols gap10">
                                            <button class="tf-button w380" type="submit" name="btnAddProduct">Thêm Mới</button>
